...
const MESSAGES = {
	...
	"preview.todo.cancel": "キャンセル",
	"preview.todo.uncancel": "キャンセル解除",
	"preview.todo.cancelledLabel": "キャンセル済み",
	...
	"webapp.tickets.title": "チケット",
	"webapp.todos.title": "TODO",
	...
	"webapp.empty.tickets.title": "チケットがありません",
	"webapp.empty.tickets.body": "プロジェクトからチケットを作成すると、ここに横断表示されます。",
	"webapp.createTicket.title": "チケットを作成",
	"webapp.createTicket.action": "＋ チケットを作成",
	"webapp.createTicket.project": "プロジェクト",
	"webapp.createTicket.noProject": "プロジェクトなし",
	"webapp.empty.todos.title": "TODOがありません",
	"webapp.empty.todos.body": "チケットやプロジェクトにTODOを追加すると、ここに横断表示されます。",
	"webapp.inbox.title": "Inbox",
	"webapp.inbox.addTodoPlaceholder": "TODOを入力してすばやく追加...",
	"webapp.inbox.addTodoButton": "追加",
	"webapp.empty.inbox.title": "Inboxは空です",
	"webapp.empty.inbox.body": "プロジェクトを選ばずにTODOやチケットをここから追加できます。",
	...
	"manage.filter.showDone": "完了・キャンセルを表示",
	...
	"manage.nav.newProjectDetail": "詳細作成...",
	...
	"onboarding.welcome.step2": "② Ticket/Todoで回す",
	"onboarding.welcome.createProject": "最初のプロジェクトを作成",
